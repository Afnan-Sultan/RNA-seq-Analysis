...
stringtie --merge $work_dir/hisat-stringtie/paper1/poly_A/reads_A/*.gtf -o $work_dir/hisat-stringtie/final_output/paper1/p1_sA_poly_stringtie_merged.gtf
stringtie --merge $work_dir/hisat-stringtie/paper1/poly_A/reads_B/*.gtf -o $work_dir/hisat-stringtie/final_output/paper1/p1_sB_poly_stringtie_merged.gtf
stringtie --merge $work_dir/hisat-stringtie/paper1/ribo_depleted/reads_A/*.gtf -o $work_dir/hisat-stringtie/final_output/paper1/p1_sA_ribo_stringtie_merged.gtf
stringtie --merge $work_dir/hisat-stringtie/paper1/ribo_depleted/reads_B/*.gtf -o $work_dir/hisat-stringtie/final_output/paper1/p1_sB_ribo_stringtie_merged.gtf
